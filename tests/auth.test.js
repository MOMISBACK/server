...
// Properly mock sendGridEmail for CommonJS BEFORE requiring the server
jest.mock('../utils/sendGridEmail');
...
beforeEach(() => {
  sendGridEmail.mockResolvedValue(true);
});
...
describe('Auth API', () => {
  ...
  it.skip('should not log in an unverified user', async () => {
